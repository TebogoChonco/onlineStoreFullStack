...
<body>
  <div class="side-menu">
    ...
    <ul>
      ...
      <li><a href="brands.php"><img src="./assets/images/brand.png" alt="">&nbsp;<span>Brands</span></a></li>
      <li><a href="orders.php"><img src="./assets/images/orders.png" alt="">&nbsp;<span>Orders</span></a></li>
      <li><a href="payments.php"><img src="./assets/images/payment.png" alt="">&nbsp;<span>Payments</span></a></li>
      <li><a href="users.php"><img src="./assets/images/users.png" alt="">&nbsp; <span>Users</span></a></li>
